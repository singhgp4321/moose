...
[ICs]
  [random1]
    ...
    value = 400e6 # Very high value to effectively disable matrix cracking
    block = 2
  []
[]
...
[Materials]
  ...
  [exp_softening]
    ...
    outputs = all
    residual_stress = 0.0 # 0.2
    beta = 0.2
  []
  [czm_mat]
    type = BiLinearMixedModeTraction
    boundary = 'Block1_Block2'
    penalty_stiffness = 1e16
    GI_c = 1.0
    GII_c = 1.0
    normal_strength = 200e6
    shear_strength = 50e6
    eta = 1.45
    viscosity = 1e-3
    displacements = 'disp_x disp_y disp_z'
...
[Postprocessors]
  ...
  [strain_xx_dispBased]
    ...
    expression = '-1.0 * avg_disp_x / ${x_length}'
    pp_names = 'avg_disp_x'
  []
  [evaluated_modulus_dispBased]
    type = ParsedPostprocessor
    expression = 'stress_xx / strain_xx_dispBased'
    pp_names = 'stress_xx strain_xx_dispBased'
  []
  [max_czm_damage]
